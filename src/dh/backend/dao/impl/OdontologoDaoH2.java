    ...
    public Odontologo registrar(Odontologo odontologo) {
        ...
        try {
            ...
            while (resultSet.next()){
                ...
                odontologoARetornar = new Odontologo(id, odontologo.getApellido(),odontologo.getNombre(),odontologo.getNumeroDeMatricula());
            }
    ...
    public List<Odontologo> listarTodos() {
        ...
        try {
            ...
            while (resultSet.next()){
                ...
                String num_matricula = resultSet.getString(4);
                Odontologo odontologo = new Odontologo(idD, apellido, nombre, num_matricula);
